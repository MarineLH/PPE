...
namespace PPE_ABAS_Hotels
{
    public partial class FMainMenu : Form
    {
        ...
        private void checkInToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            if (resa.ReservationStatus_rest_id.reservStatus_id != 2) // Si non validée
            {
                using (var connection = new MySqlConnection(Globals.MySQLConnectionString))
                {
            ...
            {
                MessageBox.Show(Resources.resa_already_checkin, Resources.info, MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
        }
        ...
        private void checkOutToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            if (resa.ReservationStatus_rest_id.reservStatus_id == 1) // Si non validée
            {
                MessageBox.Show(Resources.resa_must_checkin, Resources.info, MessageBoxButtons.OK, MessageBoxIcon.Information);
